...
const explorerThemes = {
  ...
  phonics: {
    ...
    buttonClass: "bg-teal-400 text-teal-950 border-teal-600",
  },
...
const builderThemes = {
  ...
  clothes: {
    ...
    buttonClass: "bg-indigo-400 text-indigo-950 border-indigo-600",
  },
  verbs: {
    surfaceClass: "bg-orange-100",
    accentClass: "text-orange-700",
    badgeClass: "bg-orange-200 text-orange-800",
    buttonClass: "bg-orange-400 text-orange-950 border-orange-600",
  },
  places: {
    surfaceClass: "bg-teal-100",
    accentClass: "text-teal-700",
...
export const topics: Topic[] = [
  {
    ...
    words: [
      createWord("explorer", "explorer-apple", "Apple", "/ˈæp.əl/", "Quả táo", "🍎", "Apple is red.", "Quả táo màu đỏ.", { speechText: "Apple. Apple." }),
      createWord("explorer", "explorer-bee", "Bee", "/biː/", "Con ong", "🐝", "The bee can fly.", "Con ong có thể bay.", { speechText: "Bee. Bee." }),
      createWord("explorer", "explorer-cat", "Cat", "/kæt/", "Con mèo", "🐱", "The cat is cute.", "Con mèo dễ thương.", { speechText: "Cat. Cat." }),
      createWord("explorer", "explorer-dog", "Dog", "/dɔːɡ/", "Con chó", "🐶", "The dog can run.", "Con chó có thể chạy.", { speechText: "Dog. Dog." }),
      createWord("explorer", "explorer-egg", "Egg", "/eɡ/", "Quả trứng", "🥚", "This is an egg.", "Đây là một quả trứng.", { speechText: "Egg. Egg." }),
      createWord("explorer", "explorer-fish", "Fish", "/fɪʃ/", "Con cá", "🐟", "The fish can swim.", "Con cá có thể bơi.", { speechText: "Fish. Fish." }),
      createWord("explorer", "explorer-grape", "Grape", "/ɡreɪp/", "Quả nho", "🍇", "Grapes are sweet.", "Nho rất ngọt.", { speechText: "Grape. Grape." }),
      createWord("explorer", "explorer-hat", "Hat", "/hæt/", "Cái mũ", "🎩", "I have a hat.", "Em có một cái mũ.", { speechText: "Hat. Hat." }),
      createWord("explorer", "explorer-ice-cream", "Ice cream", "/ˈaɪs ˌkriːm/", "Kem", "🍦", "Ice cream is cold.", "Kem rất lạnh.", {
        speechText: "Ice cream. Ice cream.",
      }),
      createWord("explorer", "explorer-jellyfish", "Jellyfish", "/ˈdʒel.i.fɪʃ/", "Con sứa", "🪼", "The jellyfish is blue.", "Con sứa màu xanh.", { speechText: "Jellyfish. Jellyfish." }),
      createWord("explorer", "explorer-kite", "Kite", "/kaɪt/", "Cái diều", "🪁", "The kite flies high.", "Diều bay cao.", { speechText: "Kite. Kite." }),
      createWord("explorer", "explorer-lion", "Lion", "/ˈlaɪ.ən/", "Sư tử", "🦁", "The lion is big.", "Sư tử rất to.", { speechText: "Lion. Lion." }),
      createWord("explorer", "explorer-monkey", "Monkey", "/ˈmʌŋ.ki/", "Con khỉ", "🐵", "The monkey is funny.", "Con khỉ ngộ nghĩnh.", { speechText: "Monkey. Monkey." }),
      createWord("explorer", "explorer-nest", "Nest", "/nest/", "Tổ chim", "🪹", "The bird has a nest.", "Con chim có tổ.", { speechText: "Nest. Nest." }),
      createWord("explorer", "explorer-orange-fruit", "Orange", "/ˈɒr.ɪndʒ/", "Quả cam", "🍊", "The orange is juicy.", "Quả cam mọng nước.", { speechText: "Orange. Orange." }),
    ],
  },
  {
    id: "fruits",
  ...
  },
  {
    ...
    subtitle: "Đánh vần ghép âm phonics vui nhộn",
    icon: "🔤",
    theme: explorerThemes.phonics,
    words: [
      createWord("explorer", "word-phonics-at-cat", "Cat", "/kæt/", "Con mèo (vần -at)", "🐱", "The cat sat on the mat.", "Con mèo ngồi trên chiếc thảm."),
      createWord("explorer", "word-phonics-at-hat", "Hat", "/hæt/", "Cái mũ (vần -at)", "🎩", "He wears a big hat.", "Bạn ấy đội một cái mũ to."),
      createWord("explorer", "word-phonics-at-mat", "Mat", "/mæt/", "Chiếc thảm (vần -at)", "🧹", "The cat is on the mat.", "Con mèo nằm trên thảm."),
      createWord("explorer", "word-phonics-at-rat", "Rat", "/ræt/", "Con chuột (vần -at)", "🐀", "The rat runs fast.", "Con chuột chạy rất nhanh."),
      createWord("explorer", "word-phonics-an-can", "Can", "/kæn/", "Vỏ lon (vần -an)", "🥫", "This is a soda can.", "Đây là một vỏ lon nước ngọt."),
      createWord("explorer", "word-phonics-an-fan", "Fan", "/fæn/", "Cái quạt (vần -an)", "🪭", "Turn on the fan.", "Hãy bật quạt lên."),
      createWord("explorer", "word-phonics-an-man", "Man", "/mæn/", "Người đàn ông (vần -an)", "👨", "The man is kind.", "Người đàn ông rất tốt bụng."),
      createWord("explorer", "word-phonics-an-pan", "Pan", "/pæn/", "Cái chảo (vần -an)", "🍳", "Mother cooks with a pan.", "Mẹ nấu ăn bằng cái chảo."),
      createWord("explorer", "word-phonics-pin-pin", "Pin", "/pɪn/", "Cái ghim (vần -in)", "📌", "Use a pin for paper.", "Dùng cái ghim cho tờ giấy."),
      createWord("explorer", "word-phonics-in-win", "Win", "/wɪn/", "Chiến thắng (vần -in)", "🏆", "We play and win.", "Chúng em chơi và chiến thắng."),
      createWord("explorer", "word-phonics-ig-pig", "Pig", "/pɪɡ/", "Con heo (vần -ig)", "🐷", "The pig is pink.", "Con heo màu hồng."),
      createWord("explorer", "word-phonics-ig-big", "Big", "/bɪɡ/", "To lớn (vần -ig)", "🐘", "The elephant is big.", "Con voi rất to lớn."),
      createWord("explorer", "word-phonics-og-dog", "Dog", "/dɒɡ/", "Con chó (vần -og)", "🐶", "The dog barks loudly.", "Con chó sủa to."),
      createWord("explorer", "word-phonics-og-log", "Log", "/lɒɡ/", "Khúc gỗ (vần -og)", "🪵", "The frog sits on a log.", "Con ếch ngồi trên khúc gỗ."),
      createWord("explorer", "word-phonics-un-sun", "Sun", "/sʌn/", "Mặt trời (vần -un)", "☀️", "The sun shines brightly.", "Mặt trời tỏa sáng rực rỡ."),
      createWord("explorer", "word-phonics-un-cup", "Cup", "/kʌp/", "Tách trà (vần -up)", "☕", "Drink tea in a cup.", "Uống trà bằng tách trà."),
    ],
  },
  {
    id: "family-house",
  ...
  },
  {
    ...
    subtitle: "Trang phục và phụ kiện thời trang",
    icon: "👗",
    theme: builderThemes.clothes,
    words: [
      createWord("builder", "word-clothes-shirt", "Shirt", "/ʃɜːt/", "Áo sơ mi", "👔", "He wears a white shirt.", "Bạn ấy mặc một chiếc áo sơ mi trắng."),
      createWord("builder", "word-clothes-tshirt", "T-shirt", "/ˈtiː.ʃɜːt/", "Áo phông", "👕", "I like my red T-shirt.", "Em thích chiếc áo phông màu đỏ."),
      createWord("builder", "word-clothes-dress", "Dress", "/dres/", "Váy liền", "👗", "She wears a pretty dress.", "Bạn ấy mặc một chiếc váy liền đẹp."),
      createWord("builder", "word-clothes-skirt", "Skirt", "/skɜːt/", "Chân váy", "🩱", "The skirt is blue.", "Chiếc chân váy màu xanh."),
      createWord("builder", "word-clothes-pants", "Pants", "/pænts/", "Quần dài", "👖", "My pants are clean.", "Quần dài của em rất sạch."),
      createWord("builder", "word-clothes-shorts", "Shorts", "/ʃɔːts/", "Quần đùi", "🩳", "Wear shorts in summer.", "Mặc quần đùi vào mùa hè."),
      createWord("builder", "word-clothes-shoes", "Shoes", "/ʃuːz/", "Đôi giày", "👟", "Put on your shoes.", "Hãy đi đôi giày của em."),
      createWord("builder", "word-clothes-socks", "Socks", "/sɒks/", "Đôi tất", "🧦", "Warm socks keep feet warm.", "Tất ấm giữ ấm bàn chân."),
      createWord("builder", "word-clothes-jacket", "Jacket", "/ˈdʒæk.ɪt/", "Áo khoác", "🧥", "Wear a jacket when cold.", "Mặc áo khoác khi trời lạnh."),
      createWord("builder", "word-clothes-hat", "Hat", "/hæt/", "Cái mũ", "👒", "She has a yellow hat.", "Bạn ấy có một cái mũ màu vàng."),
      createWord("builder", "word-clothes-glasses", "Glasses", "/ˈɡlɑː.sɪz/", "Kính mắt", "👓", "Grandfather wears glasses.", "Ông đeo kính mắt."),
      createWord("builder", "word-clothes-watch", "Watch", "/wɒtʃ/", "Đồng hồ đeo tay", "⌚", "Look at the watch.", "Hãy nhìn vào chiếc đồng hồ."),
    ],
  },
  {
    id: "action-verbs",
    level: "builder",
    title: "Action Verbs",
    subtitle: "Động từ hành động hằng ngày",
    icon: "🏃",
    theme: builderThemes.verbs,
    words: [
      createWord("builder", "word-verbs-run", "Run", "/rʌn/", "Chạy", "🏃", "I can run fast.", "Em có thể chạy rất nhanh."),
      createWord("builder", "word-verbs-jump", "Jump", "/dʒʌmp/", "Nhảy", "🦘", "Kangaroo can jump high.", "Chuột túi có thể nhảy cao."),
      createWord("builder", "word-verbs-swim", "Swim", "/swɪm/", "Bơi", "🏊", "Fish can swim in water.", "Cá có thể bơi trong nước."),
      createWord("builder", "word-verbs-fly", "Fly", "/flaɪ/", "Bay", "🕊️", "Birds fly in the sky.", "Loài chim bay trên bầu trời."),
      createWord("builder", "word-verbs-climb", "Climb", "/klaɪm/", "Leo trèo", "🧗", "Monkeys climb trees.", "Con khỉ leo trèo trên cây."),
      createWord("builder", "word-verbs-eat", "Eat", "/iːt/", "Ăn", "🍽️", "We eat healthy food.", "Chúng em ăn thực phẩm lành mạnh."),
      createWord("builder", "word-verbs-drink", "Drink", "/drɪŋk/", "Uống", "🥛", "Drink water every day.", "Hãy uống nước mỗi ngày."),
      createWord("builder", "word-verbs-sleep", "Sleep", "/sliːp/", "Ngủ", "😴", "Sleep eight hours a night.", "Ngủ tám tiếng mỗi đêm."),
      createWord("builder", "word-verbs-wash", "Wash", "/wɒʃ/", "Rửa", "🧼", "Wash your hands carefully.", "Hãy rửa tay cẩn thận."),
      createWord("builder", "word-verbs-draw", "Draw", "/drɔː/", "Vẽ", "🎨", "I draw a red star.", "Em vẽ một ngôi sao màu đỏ."),
      createWord("builder", "word-verbs-sing", "Sing", "/sɪŋ/", "Hát", "🎤", "Birds sing in spring.", "Chim ca hát vào mùa xuân."),
      createWord("builder", "word-verbs-dance", "Dance", "/dɑːns/", "Nhảy múa", "💃", "Children dance together.", "Trẻ em cùng nhau nhảy múa."),
      createWord("builder", "word-verbs-read", "Read", "/riːd/", "Đọc", "📖", "Read books every day.", "Đọc sách mỗi ngày."),
      createWord("builder", "word-verbs-write", "Write", "/raɪt/", "Viết", "✍️", "Write your name clearly.", "Viết tên của em rõ ràng."),
      createWord("builder", "word-verbs-clap", "Clap", "/klæp/", "Vỗ tay", "👏", "Clap your hands together.", "Cùng nhau vỗ tay nhé."),
    ],
  },
  {
    id: "places-nature",
    level: "builder",
    title: "Places & Nature",
    subtitle: "Địa điểm và thiên nhiên tươi đẹp",
    icon: "🏞️",
    theme: builderThemes.places,
    words: [
      createWord("builder", "word-places-park", "Park", "/pɑːk/", "Công viên", "🏞️", "We play in the park.", "Chúng em chơi trong công viên."),
      createWord("builder", "word-places-beach", "Beach", "/biːtʃ/", "Bãi biển", "🏖️", "The beach is sandy.", "Bãi biển đầy cát."),
      createWord("builder", "word-places-farm", "Farm", "/fɑːm/", "Nông trại", "🚜", "Cows live on a farm.", "Bò sống ở nông trại."),
      createWord("builder", "word-places-shop", "Shop", "/ʃɒp/", "Cửa hàng", "🛍️", "Mother goes to the shop.", "Mẹ đi tới cửa hàng."),
      createWord("builder", "word-places-hospital", "Hospital", "/ˈhɒs.pɪ.təl/", "Bệnh viện", "🏥", "Doctors work in a hospital.", "Bác sĩ làm việc ở bệnh viện."),
      createWord("builder", "word-places-street", "Street", "/striːt/", "Đường phố", "🛣️", "Cars run on the street.", "Ô tô chạy trên đường phố."),
      createWord("builder", "word-places-river", "River", "/ˈrɪv.ər/", "Dòng sông", "🌊", "The river flows to sea.", "Dòng sông chảy ra biển."),
      createWord("builder", "word-places-sea", "Sea", "/siː/", "Biển", "🌊", "The sea is blue and deep.", "Biển màu xanh và sâu."),
      createWord("builder", "word-places-tree", "Tree", "/triː/", "Cây xanh", "🌳", "Birds nest in the tree.", "Chim làm tổ trên cây."),
      createWord("builder", "word-places-flower", "Flower", "/ˈflaʊ.ər/", "Bông hoa", "🌻", "The flower smells sweet.", "Bông hoa tỏa hương thơm."),
      createWord("builder", "word-places-sun", "Sun", "/sʌn/", "Mặt trời", "☀️", "The sun gives light.", "Mặt trời tỏa ánh sáng."),
      createWord("builder", "word-places-moon", "Moon", "/muːn/", "Mặt trăng", "🌙", "The moon shines at night.", "Mặt trăng tỏa sáng vào ban đêm."),
    ],
  },
  {
    ...
    subtitle: "Cảm xúc và tính từ miêu tả",
    icon: "😃",
    theme: builderThemes.emotions,
    words: [
      createWord("builder", "word-emotions-happy", "Happy", "/ˈhæp.i/", "Vui vẻ", "😃", "I am happy today.", "Hôm nay em rất vui vẻ."),
      createWord("builder", "word-emotions-sad", "Sad", "/sæd/", "Buồn ã", "😢", "Don't be sad, my friend.", "Đừng buồn nhé, bạn của em."),
      createWord("builder", "word-emotions-angry", "Angry", "/ˈæŋ.ɡri/", "Tức giận", "😡", "Take a deep breath when angry.", "Hãy hít thở sâu khi tức giận."),
      createWord("builder", "word-emotions-tired", "Tired", "/taɪəd/", "Mệt mỏi", "😫", "I feel tired after running.", "Em cảm thấy mệt mỏi sau khi chạy."),
      createWord("builder", "word-emotions-hungry", "Hungry", "/ˈhʌŋ.ɡri/", "Đói bụng", "🍔", "I am hungry for lunch.", "Em đang đói bụng cho bữa trưa."),
      createWord("builder", "word-emotions-thirsty", "Thirsty", "/ˈθɜː.sti/", "Khát nước", "🥤", "Drink water when thirsty.", "Hãy uống nước khi khát."),
      createWord("builder", "word-emotions-big", "Big", "/bɪɡ/", "To lớn", "🐘", "The elephant is very big.", "Con voi rất to lớn."),
      createWord("builder", "word-emotions-small", "Small", "/smɔːl/", "Nhỏ bé", "🐭", "The mouse is very small.", "Con chuột rất nhỏ bé."),
      createWord("builder", "word-emotions-fast", "Fast", "/fɑːst/", "Nhanh", "⚡", "Cheetah runs very fast.", "Báo gấm chạy rất nhanh."),
      createWord("builder", "word-emotions-slow", "Slow", "/sləʊ/", "Chậm chạp", "🐢", "The turtle is slow.", "Con rùa rất chậm chạp."),
      createWord("builder", "word-emotions-hot", "Hot", "/hɒt/", "Nóng", "🔥", "Summer days are hot.", "Những ngày mùa hè rất nóng."),
      createWord("builder", "word-emotions-cold", "Cold", "/kəʊld/", "Lạnh", "❄️", "Ice cream is cold.", "Kem rất lạnh."),
    ],
  },
  {
    id: "daily-routine",
